...
function renderProperties(){
  ...
  if(id==='title'){name='图题';html=fieldGroup([
    ...
    ...(state.chart.type==='bar'?[checkField('barLineMode','柱线组合（柱顶叠加均值趋势线）'),rangeField('barLineWidth','趋势线粗细',.8,5,.1),checkField('barLineMarker','趋势线数据点')]:[])
