const CACHE = 'foodlab-studio-v0.73.0';
const BOOT_GUARD_FILE = './boot-guard-v0154.js?v=0.73.0';
const MAINTENANCE_FILE = './maintenance-v0149.js?v=0.14.9';
const TEMPLATE_FILE = './data-templates-v0150.js?v=0.73.0';
...
const ASSETS = [
  ...
  './styles.css?v=0.73.0',
  './app.js?v=0.73.0',
  './chart-fixes.js?v=0.73.0',
  './template-fixes.js?v=0.73.0',
  BOOT_GUARD_FILE,
  MAINTENANCE_FILE,
  TEMPLATE_FILE,
  UNIVARIATE_FILE,
...
function patchLoaderSource() {
  return `\n;(() => {\n` +
    ...
    `    ['foodlab-data-templates-v0150','./data-templates-v0150.js?v=0.73.0'],\n` +
