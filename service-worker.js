const CACHE = 'foodlab-studio-v0.15.4';
const BOOT_GUARD_FILE = './boot-guard-v0154.js?v=0.15.4';
...
const ASSETS = [
  ...
  './styles.css?v=0.15.4',
  './app.js?v=0.15.4',
  './chart-fixes.js?v=0.15.4',
  './template-fixes.js?v=0.15.4',
  BOOT_GUARD_FILE,
  MAINTENANCE_FILE,
  TEMPLATE_FILE,
  UNIVARIATE_FILE,
...
async function withPatchLoaders(response) {
  ...
  const body = text.includes('foodlab-perf-v0154') ? text : text + patchLoaderSource();
